...
export function Navbar_menu({email}){
    ...
    return (
      ...
      <div className="border-[2px] border-black font-bold p-[10px] hover:bg-slate-600 hover:text-[white]">{email}</div>
    ...
    {toggle? 
      <div className="flex flex-col items-center absolute right-[60px] mt-[65px] top-[37px] border-[1px] border-black ">
        <button  onClick={()=>navigate("/home")} className="border-[1px] border-black w-full p-[10px] font-bold hover:bg-slate-600 hover:text-[white]">Home</button>
